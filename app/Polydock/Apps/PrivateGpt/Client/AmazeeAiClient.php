...
class AmazeeAiClient
{
    ...
    public function createTeam(string $name, string $adminEmail): TeamResponse
    {
        try {
            ...
            if (! is_array($data)) {
                throw new AmazeeAiClientException('Failed to create team: Invalid or empty API response');
            }
    ...
    public function deleteTeam(string $teamId): string
    {
        try {
            ...
            return is_array($data) && isset($data['message']) ? (string) $data['message'] : '';
    ...
    public function getRegions(): array
    {
        try {
            ...
            if (! is_array($data)) {
                throw new AmazeeAiClientException('Failed to get regions: Invalid or empty API response');
            }
    ...
    public function createBackendKey(int $teamId): APIToken
    {
        try {
            ...
            if (! is_array($data)) {
                throw new AmazeeAiClientException('Failed to generate backend key: Invalid or empty API response');
            }
    ...
    public function createLlmKey(int $teamId, int $regionId): LlmKeysResponse
    {
        try {
            ...
            if (! is_array($data)) {
                throw new AmazeeAiClientException('Failed to generate LLM keys: Invalid or empty API response');
            }
    ...
    public function generateVdbKeys(string $teamId): VdbKeysResponse
    {
        try {
            ...
            if (! is_array($data)) {
                throw new AmazeeAiClientException('Failed to generate VDB keys: Invalid or empty API response');
            }
    ...
    public function getTeam(string $teamId): TeamResponse
    {
        try {
            ...
            if (! is_array($data)) {
                throw new AmazeeAiClientException('Failed to get team: Invalid or empty API response');
            }
    ...
    public function health(): HealthResponse
    {
        try {
            ...
            if (! is_array($data)) {
                throw new AmazeeAiClientException('Failed to check health: Invalid or empty API response');
            }
