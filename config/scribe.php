...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Authentication is handled via Sanctum Bearer tokens. You can retrieve your token by authenticating or visiting your dashboard to generate an API token. Include it in your requests as an `Authorization: Bearer {YOUR_AUTH_TOKEN}` header.',
    ],
